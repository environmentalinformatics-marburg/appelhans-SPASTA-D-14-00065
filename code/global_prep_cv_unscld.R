...
save(exp_var_stck_sp, file = "data/exp_var_stck_sp_unscld.rda")


### create full data set for final interpolation
save(ta.pred, file = "data/ta.pred.complete.unscld.rda") # train data

save(exp.var.stck.cr, file = "data/exp.var.stck.cr.unscld.rda")
save(ndvi.stck.cr, file = "data/ndvi.stck.cr.unscld.rda")
