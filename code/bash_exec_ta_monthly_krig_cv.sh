...
nohup R --slave --vanilla --file=ta_monthly_krigD_cv.R > ../logs/ta_monthly_krigD_cv_201504081000.out &
nohup R --slave --vanilla --file=ta_monthly_krigDN_cv.R > ../logs/ta_monthly_krigDN_cv_201504081000.out &
nohup R --slave --vanilla --file=ta_monthly_krigDSN_cv.R > ../logs/ta_monthly_krigDSN_cv_201504081000.out &
